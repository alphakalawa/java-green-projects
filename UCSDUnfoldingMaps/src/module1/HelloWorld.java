...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		this.background(165, 210, 168);
		
		// Select a map provider
		AbstractMapProvider provider_1 = new Google.GoogleSimplifiedProvider();
		//AbstractMapProvider provider_2 = new Microsoft.HybridProvider();
		AbstractMapProvider provider_2 = new Microsoft.RoadProvider();
		// Set a zoom level
		int zoomLevel = 10;
		...
		if (offline) {
			...
			provider_1 = new MBTilesMapProvider(mbTilesString);
		...
		map1 = new UnfoldingMap(this, 40, 50, 350, 500, provider_1);
		...
		map2 = new UnfoldingMap(this, 410, 50, 350, 500, provider_2);
		map2.zoomAndPanTo(zoomLevel, new Location(39.9f, -75.3f));
